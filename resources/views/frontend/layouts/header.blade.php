<header>
                ...
                <div class="wsus__call_icon_area">
                    ...
                    <ul class="wsus__icon_area">
                        ...
                        <li><a href="{{ route('user.wishlist.index') }}"><i
                                    class="fal fa-heart"></i><span id="wishList_count">{{ \App\Models\WishList::where('user_id', auth()->user()->id)->count() }} </span> </a></li>
    ...
    <div class="wsus__mini_cart">
                ...
                <li id="mini_cart_{{ $sidebarProduct->rowId }}">
                    ...
                    <div class="wsus__cart_text">
                        ...
                        <small>Variants total:
                            {{ $setting->currency_icon }}{{ $sidebarProduct->options->variants_total }}</small>
                        <br>
        ...
        <div class="mini_cart_actions {{ Cart::content()->count() == 0 ? 'd-none' : '' }}">
            <h5>sub total <span id="mini_cart_subtotal">{{ $setting->currency_icon }}{{ getTotalCartCount() }}</span>
            </h5>
