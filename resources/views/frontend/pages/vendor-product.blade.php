                                ...
                                <div class="wsus__pro_page_bammer_text wsus__vendor_det_banner_text">
                                    <div class="wsus__vendor_text_center">
                                        ...
                                        <ul class="d-flex">
                                            ...
                                            <li><a class="twitter" href="{{ $vendor->fb_link }}"><i class="fab fa-twitter"></i></a></li>
                ...
                <div class="col-xl-12 col-lg-8">
                    <div class="row">
                            ...
                            <div class="wsus__product_topbar">
                                ...
                                <div class="wsus__product_topbar_left">
                                    <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <button
                                            class="nav-link list_view {{ session()->has('product-list-style') && session()->get('product-list-style') == 'list' ? 'active' : '' }}"
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                                            ...
                                            <div class="wsus__product_item">
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <form class="shopping-cart-form">
                                                        ...
                                                        <button class="add_cart" style="border: none" href="#"
                                                            type="submit">add to
                                                            cart</button>
                                                    </form>
                            ...
                            <div class="tab-pane fade {{ session()->has('product-list-style') && session()->get('product-list-style') == 'list' ? 'show active' : '' }}"
                                                    ...
                                                    <ul class="wsus__single_pro_icon">
                                                        <form class="shopping-cart-form">
                                                            ...
                                                            <button class="add_cart"
                                                                style="border: none; margin-right:10px" href="#"
                                                                type="submit">add to
                                                                cart</button>
                                                        </form>
                                                        <li><a data-id="{{ $product->id }}" class="addToWishlist"
