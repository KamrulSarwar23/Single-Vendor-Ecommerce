                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="wsus__contact_single">
                                        ...
                                        <h5>mail address</h5>
                                        <a href="mailto:example@gmail.com">{{ @$contactinfo->contact_email }}</a>
                                ...
                                <div class="col-xl-12">
                                    <div class="wsus__contact_single">
                                        ...
                                        <h5>phone number</h5>
                                        <a href="macallto:+69522145000001">{{ @$contactinfo->contact_phone }}</a>
                                ...
                                <div class="col-xl-12">
                                    <div class="wsus__contact_single">
                                        ...
                                        <a href="mailto:example@gmail.com">{{ @$contactinfo->contact_address }}</a>
                        ...
                        <div class="col-xl-12">
                            <div class="wsus__con_map">
                                <iframe src="{{ @$contactinfo->map }}" width="1600" height="450" style="border:0;"
