            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7">
                    <div class="wsus__check_form">
                        <h5>Shipping Details <a class="btn btn-success" href="#" data-bs-toggle="modal"
                    ...
                    <div class="wsus__order_details" id="sticky_sidebar">
                        ...
                        <div class="wsus__order_details_summery">
                            ...
                            <p><b>total:</b> <span><b id="total_amount"
                                        data-id="{{ getMainCartCount() }}">{{ $setting->currency_icon }}{{ getMainCartCount() }}</b></span>
                            </p>
                        </div>
                        <div class="terms_area">
                            <div class="form-check">
                                <input class="form-check-input agree_form" type="checkbox" value=""
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.shipping_method').on('click', function() {
                    ...
                    $('#shipping_fee').text("{{ $setting->currency_icon }}" + shippingFee);
                ...
                $('#submitCheckOutForm').on('click', function(e) {
                    ...
                    if ($('#shipping_method_id').val() == "") {
                    ...
                    } else if (!$('.agree_form').prop('checked')) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $('#submitCheckOutForm').html('Order Placed Successfully')
