@php
    $CategorySliderOneProduct = json_decode($categorySliderProductOne->value);
    $lastKey = [];
    foreach ($CategorySliderOneProduct as $key => $category) {
        if ($category == null) {
            break;
        }
                    ...
                    <div class="wsus__product_item">
                        ...
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal"
                                    data-bs-target="#categorySliderOne-{{ $product->id }}"><i class="far fa-eye"></i></a>
                            </li>
                            <li><a data-id="{{ $product->id }}" class="addToWishlist" href="#"><i class="far fa-heart"></i></a></li>
...
<section>
    @foreach ($products as $product)
        <section class="product_popup_modal">
            <div class="modal fade" id="categorySliderOne-{{ $product->id }}" tabindex="-1" aria-hidden="true">
